...
// The AI API key is NOT stored in this public frontend.
// Deploy ai-worker.js as a Cloudflare Worker and put the
// OpenRouter API key in the Worker secret named OPENROUTER_API_KEY.
// Then paste your Worker URL below.
const AI_PROXY_URL = "https://studyflow-ai.dinalshyavin.workers.dev";
...
async function sendChatMessage() {
    ...
    if (
        !AI_PROXY_URL ||
        AI_PROXY_URL.includes("PASTE_YOUR_CLOUDFLARE_WORKER_URL_HERE")
    ) {
        alert(
            "AI chatbot is not configured yet!\n\nOpen app.js and paste your Cloudflare Worker URL into AI_PROXY_URL."
        );
        return;
    }
